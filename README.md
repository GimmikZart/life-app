...
Life App uses the local port range `53321-53324` plus analytics on `53327`.
(Originariamente `5532x`, spostate per evitare i range di porte riservati da Windows/WinNAT.)
